...
Q_CONSTINIT static const qt_meta_stringdata_CLASSpopUpENDCLASS_t qt_meta_stringdata_CLASSpopUpENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 14),  // "restartClicked"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 13)   // "finishClicked"
    },
    "popUp",
    "restartClicked",
    "",
...
void popUp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (popUp::*)();
            if (_t _q_method = &popUp::restartClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (popUp::*)();
            if (_t _q_method = &popUp::finishClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void popUp::restartClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void popUp::finishClicked()
{
